...
//
#define PABB_PROTOCOL_VERSION       2021020502

//  Program versioning doesn't matter. It's just for informational purposes.
#define PABB_PROGRAM_VERSION        2021020501

#define PABB_BAUD_RATE              115200
#define PABB_RETRANSMIT_DELAY       10

#define PABB_MAX_MESSAGE_SIZE       15
#define PABB_MESSAGE_OVERHEAD       (2 + sizeof(uint32_t))
